...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, ULPI_CLK_EN_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : ULPI_CLK_EN_Pin ULPI_nRESET_Pin CAN_SLOPE_Pin */
  GPIO_InitStruct.Pin = ULPI_CLK_EN_Pin|ULPI_nRESET_Pin|CAN_SLOPE_Pin;
  ...
  /*Configure GPIO pin : MASTER_TIMESYNC_nOE_Pin */
  GPIO_InitStruct.Pin = MASTER_TIMESYNC_nOE_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_MEDIUM;
