...
pushd $GITHUB_WORKSPACE/build/ram/release/hadoucan-fw
sha256sum -b hadoucan-fw.elf hadoucan-fw.bin | tee sha256.txt
tar -czf $GITHUB_WORKSPACE/hadoucan-fw-release-$GITHUB_SHA.tar.gz  hadoucan-fw.elf hadoucan-fw.bin sha256.txt
popd
